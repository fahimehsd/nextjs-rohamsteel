  ...
  return (
    <div className="p-5 m-2 bg-white shadow-md w-full">
      ...
      <p className=" first-letter:pr-4 mt-3">
        ...
        تأکید بر حفاظت از محیط زیست است به نحوی که با احداث نیروگاه، آب و برق
        مورد نیاز خود را تأمین کند. و همین‌طور برای ۲۶ مگاوات برق موردنیاز
        نیروگاه ۵۰ مگاواتی احداث خواهد شد.
      </p>
    </div>
  );
};
